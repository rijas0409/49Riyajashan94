...
import { 
  ...
  CalendarDots, Wallet, User, Buildings
...
const ClinicVisitDetails = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const { visit } = (location.state as ClinicVisitDetailsState) || {
    visit: {
      id: "CV-123",
      petName: "Bella",
      ...
      address: "VetCare Clinic, Sector 5",
      time: "Today, 01:00 PM (In 2 hours)",
        ...
        <div className="space-y-5">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-[15px] font-bold">Clinic Visit</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="w-11 h-11 rounded-[14px] bg-[#f1f4ff] flex items-center justify-center text-[#a347ff]">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <p className="text-[11px] text-[#9ba1b9] font-semibold mb-1">Clinic Address</p>
