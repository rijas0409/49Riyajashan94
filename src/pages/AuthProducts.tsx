...
import { Heart, Loader2, ShoppingBag, Shield, Award, Package } from "lucide-react";
import { z } from "zod";
        ...
        <Card className="w-full max-w-md border-0 shadow-card animate-fade-in">
          <CardHeader className="text-center space-y-2">
            ...
            <CardTitle className="text-2xl">
              {isLogin ? "Product Seller Login" : "Become a Product Seller"}
            </CardTitle>
            <CardDescription>
              {isLogin
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isLoading ? (
                  ...
                  isLogin ? "Sign In" : "Create Product Seller Account"
                )}
              </Button>
            </form>
