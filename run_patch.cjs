                ...
                {selectedUser.role === 'vet' ? (
                  <>
                    <button 
                      ...
                      className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-[15px] border border-transparent disabled:opacity-40 disabled:cursor-not-allowed hover:bg-[hsl(220,20%,96%)] text-[hsl(220,20%,30%)] transition-all"
                    >
