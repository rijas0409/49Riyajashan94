...
-- Run this in Supabase SQL Editor to resolve all "column not found" and "RLS policy" issues
...
-- 12. Ensure storage bucket exists and is accessible
-- Run these one-by-one if the block fails
DO $$
BEGIN
